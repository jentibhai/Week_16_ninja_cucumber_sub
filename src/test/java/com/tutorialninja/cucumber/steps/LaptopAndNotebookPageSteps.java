...
public class LaptopAndNotebookPageSteps {
    ...
    public void iShouldNavigateToCheckoutPage() {
        Assert.assertEquals("Not Navigate to checkout page","Checkout", new com.tutorialninja.pages.CheckoutPage().getCheckoutText());
    }

    @And("^I should see new customer text$")
    public void iShouldSeeNewCustomerText() throws InterruptedException{
        Thread.sleep(500);
        Assert.assertEquals("New Customer Text not found","New Customer", new com.tutorialninja.pages.CheckoutPage().getNewCustomerText());
    }

    @And("^I click on guest checkout button$")
    public void iClickOnGuestCheckoutButton() throws InterruptedException{
        Thread.sleep(500);
        new com.tutorialninja.pages.CheckoutPage().clickOnGuestCheckOutRadioButton();
    }

    @And("^I click on continue button of guest checkout page$")
    public void iClickOnContinueButtonOfGuestCheckoutPage() {
        new com.tutorialninja.pages.CheckoutPage().clickOnContinueButton();
    }

    @And("^I filled all mandatory field of checkout page$")
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new com.tutorialninja.pages.CheckoutPage().enterFirstName("Manisha");
        new com.tutorialninja.pages.CheckoutPage().enterLastName("Mavani");
        new com.tutorialninja.pages.CheckoutPage().enterEmailId("Manisha");
        new com.tutorialninja.pages.CheckoutPage().enterTelephone("07878963869");
        new com.tutorialninja.pages.CheckoutPage().enterAddressLine1("20,Birmingham road");
        new com.tutorialninja.pages.CheckoutPage().enterCity("Birmingham");
        new com.tutorialninja.pages.CheckoutPage().enterPostCode("CV0 10Ol");
        new com.tutorialninja.pages.CheckoutPage().selectCountry("India");
        new com.tutorialninja.pages.CheckoutPage().selectRegion("Gujarat");
    ...
    public void iClickOnContinueAfterFillAllDetailOnCheckoutPage() {
        new com.tutorialninja.pages.CheckoutPage().clickOnContinue();
    }

    @And("^I add comments to text area about product order$")
    public void iAddCommentsToTextAreaAboutProductOrder() {
        new com.tutorialninja.pages.CheckoutPage().addCommentsToTextArea("Happy Christmas!");
    }

    @And("^I click checkbox of terms and condition$")
    public void iClickCheckboxOfTermsAndCondition() {
        new com.tutorialninja.pages.CheckoutPage().checkTermsAndConditionCheckBox();
    }

    @And("^I click on continue of checkout$")
    public void iClickOnContinueOfCheckout() {
        new com.tutorialninja.pages.CheckoutPage().clickContinue();
    }

    @Then("^I should see warning message regarding Payment method$")
    public void iShouldSeeWarningMessageRegardingPaymentMethod() {
        Assert.assertTrue("Warning message not displayed",new com.tutorialninja.pages.CheckoutPage().getWarningMessage().contains("Warning: Payment method required!"));
    }
